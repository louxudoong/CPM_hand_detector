...
from thirdparty import Mytransforms
import json

root_dir = "/home/aistudio/data/data227171"
...
class FreiHand_Data:
    ...
    def __getitem__(self, index):
        ...
        img = copy.deepcopy(Mytransforms.normalize(Mytransforms.to_tensor(img), np.array([128., 128., 128.]),
                                np.array([256., 256., 256.])))
        # img = Mytransforms.to_tensor(img)  在normalize已经to_tensor过了！！！！
        heatmap = copy.deepcopy(Mytransforms.to_tensor(heatmap))
        centermap = copy.deepcopy(Mytransforms.to_tensor(centermap))
